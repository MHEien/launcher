...
CREATE TYPE "public"."build_status" AS ENUM('pending', 'building', 'success', 'failed');--> statement-breakpoint
CREATE TYPE "public"."platform" AS ENUM('windows', 'macos', 'macos_arm', 'linux', 'linux_appimage', 'linux_deb');--> statement-breakpoint
CREATE TYPE "public"."plugin_status" AS ENUM('draft', 'pending_review', 'published', 'rejected', 'deprecated');--> statement-breakpoint
...
CREATE TABLE "plugin_versions" (
	...
	"ai_tool_schemas" jsonb DEFAULT '{}'::jsonb,
	"min_launcher_version" varchar(50),
	"changelog" text,
...
--> statement-breakpoint
ALTER TABLE "plugin_builds" ADD CONSTRAINT "plugin_builds_plugin_id_plugins_id_fk" FOREIGN KEY ("plugin_id") REFERENCES "public"."plugins"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "plugin_builds" ADD CONSTRAINT "plugin_builds_version_id_plugin_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."plugin_versions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "plugin_downloads" ADD CONSTRAINT "plugin_downloads_plugin_id_plugins_id_fk" FOREIGN KEY ("plugin_id") REFERENCES "public"."plugins"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "plugin_downloads" ADD CONSTRAINT "plugin_downloads_version_id_plugin_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."plugin_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "usage_aggregates_user_month_idx" ON "usage_aggregates" USING btree ("user_id","month");